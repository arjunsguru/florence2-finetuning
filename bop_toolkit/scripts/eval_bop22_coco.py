...
for result_filename in p['result_filenames']:
  ...
  dataset_coco_ann_path = "./dataset_coco_ann.json"
  # Save the dataset_coco_ann dict to the above file
  inout.save_json(dataset_coco_ann_path, dataset_coco_ann)
